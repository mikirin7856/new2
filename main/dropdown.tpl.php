<div class="meta-message meta-message-<?php echo $messageId?>">
    <div class="meta-auto-hide pt-1 pb-1 pe-1 ps-2">
        ...
        <button type="button" class="btn btn-sm btn-outline-primary" data-id="<?php echo $messageId?>" onclick="lhinst.dropdownClicked(<?php echo $messageId?>,$(this))"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('genericbot/list','Choose')?></button>
    </div>
</div>