...
<div class="row">
    ...
    <div class="col-2">
		<input type="button" class="btn btn-secondary float-end closebutton" value="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/chat','Close')?>" onclick="lhinst.userclosedchatandbrowser();" />
	</div>
	<?php endif;?>
</div>
