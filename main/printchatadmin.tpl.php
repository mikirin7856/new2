<div class="fs12">
<h4><?php echo htmlspecialchars($chat->nick)?><?php $chat->city != '' ? print ', '.htmlspecialchars($chat->city) : ''?>, <?php echo date(erLhcoreClassModule::$dateDateHourFormat,$chat->time)?> <div class="float-end">IP:<?php echo htmlspecialchars($chat->ip)?>, ID: <?php echo $chat->id?></div></h4>
